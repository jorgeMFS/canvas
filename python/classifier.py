...
if __name__ == "__main__":
    print(f"{bcolors.OKGREEN}Starting Classification process...{bcolors.ENDC}")
    xls_path="../xlslist"
    classification(xls_path)
    print(f"{bcolors.OKGREEN}The program successfully stored all classification results in /xlslist folder.{bcolors.ENDC}")
